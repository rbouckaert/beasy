...
public interface CAListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CAParser#sharetype}.
	 * @param ctx the parse tree
	 */
	void enterSharetype(CAParser.SharetypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link CAParser#sharetype}.
	 * @param ctx the parse tree
	 */
	void exitSharetype(CAParser.SharetypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CAParser#mode_}.
	 * @param ctx the parse tree
	 */
	void enterMode_(CAParser.Mode_Context ctx);
	/**
	 * Exit a parse tree produced by {@link CAParser#mode_}.
	 * @param ctx the parse tree
	 */
	void exitMode_(CAParser.Mode_Context ctx);
	/**
