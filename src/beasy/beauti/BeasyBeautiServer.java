...
import beasy.beauti.inputeditor.BeasyHTMLEditorFactory;
import beasy.beauti.inputeditor.BeasyHTMLInputEditor;
import methods.ImageUtil;
import methods.ModelEditor;
import methods.implementation.BEASTObjectMethodsText;

public class BeasyBeautiServer extends Runnable {
	BeautiDoc beautiDoc;
	Beauti beauti;
	String html;
	List<String> m;
	...
	public BeasyBeautiServer(BeautiDoc doc) {
		beautiDoc = doc;
		beauti = new Beauti(beautiDoc);
	}
    ...
    class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
        	...
        	if (request.startsWith("/cmd=Edit")) {
        		...
        		response = getHTMLEditor(o, beautiDoc);
System.out.println(response);
    	...
    	private String processCmd(String request) {
			// TODO Auto-generated method stub
			return null;
		}


		BeasyHTMLEditorFactory objectEditorFactory;
    	
    	public String getHTMLEditor(BEASTInterface o, BeautiDoc doc) {
    		if (objectEditorFactory == null) {
    			objectEditorFactory = new BeasyHTMLEditorFactory();
    		...
    		for (Input<?> input : o.listInputs()) {
    			try {
    				BeasyHTMLInputEditor editor = objectEditorFactory.getBeasyHTMLInputEditor(o, input, doc);
    				html.append("<tr>");
    ...
    public static void main(String[] args) throws Exception {
		MCMC mcmc = null;
		BeasyBeautiServer server = new BeasyBeautiServer();
		...
		// BeasyHTMLInputEditor.initNameMap();
		server.run();
