...
public class DOI2Citation extends Runnable {
	...
	String bibtex;
	/** bibtex cache **/
	static Properties DOI2BibtexMap;
	...
	static void initialise() {
		if (DOI2BibtexMap == null) {
			DOI2BibtexMap = loadMap();
		}
	}
	...
	static public void saveMap() {
        ...
        try {
        	DOI2BibtexMap.store(new FileOutputStream(propsFile),
	...
	public void run() throws Exception {
		...
		// check the cache
		if (styleInput.get().equals("bibtex") && DOI2BibtexMap.containsKey(DOI)) {
			bibtex = (String) DOI2BibtexMap.get(DOI);
			return;
		}
